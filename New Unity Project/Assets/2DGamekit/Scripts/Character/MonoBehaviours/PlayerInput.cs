...
namespace Gamekit2D
{
    public class PlayerInput : InputComponent, IDataPersister
    {
        ...
        public InputButton ReverseGravity = new InputButton(KeyCode.Z, XboxControllerButtons.LeftBumper);
        public InputButton RevertGravity = new InputButton(KeyCode.X, XboxControllerButtons.None);
        ...
        protected override void GetInputs(bool fixedUpdateHappened)
        {
            ...
            RevertGravity.Get(fixedUpdateHappened, inputType);
        ...
        public override void ReleaseControl(bool resetValues = true)
        {
            ...
            ReleaseControl(RevertGravity, resetValues);
        }
